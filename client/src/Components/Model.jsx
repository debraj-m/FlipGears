...
},
{
    ...
    key:"mfg-expiry-detection-model",
...
setSelectedModel(data.find((model) => model.name === modelName));
};
    ...
    {data.map((elem, index) => (
        <div key={index} className='Regular w-full lg:h-[100vw] bg-[#efeeed] relative flex flex-col justify-center items-center rounded-t-[8vw] mb-[4vw]'>
            <h1 className='flex justify-center items-center text-[2.8vh] mt-[3vh] lg:mt-[0vh] lg:text-[3.4vw] Medium capitalize'>
                <img src={elem.img} alt="...." />{elem.key}
            </h1>

            <h2 className='text-[1.5vh] lg:text-[1.6vw] w-[80%] text-center leading-[1.9vh] lg:leading-[2vw]'>
                <span className='text-[1.8vh] lg:text-[2vw] font-semibold '>Purpose: </span>{elem.purpose}
            </h2>
            ...
            <div className='w-full h-[35vh] lg:h-[30vw] relative flex justify-evenly items-center bg-[#efeeed] rounded-b-[8vw]'>
                <div className='w-[45%] h-full gap-[2vw] flex flex-col relative justify-center left-[3vw] items-center'>
                    <button onClick={() =>setIsPopupOpen(true)} className='bg-white w-[12vh] h-[4vh] text-[1vh] lg:w-[13vw] lg:h-[4vw] lg:text-[1vw] capitalize rounded-[5vw]'>
                        Use this Model
                    </button>
                    <h3 className='w-[13vh] text-[1.1vh] lg:w-[13vw] lg:text-[1.1vw] capitalize flex justify-center'>
                        (camera Access Required)
                    </h3>
                    {isPopupOpen && (
    <Popup modelName={elem.key }onClose={() => setIsPopupOpen(false)} />
    )}
                </div>
                <div className='w-[55%] h-full relative flex'>
                    <p className='w-[80%] lg:w-[75%] h-full font-medium text-[1vh] lg:text-[1.4vw] relative top-[4vh] lg:top-[3vw] lg:left-[4vw]'>
                        {elem.description}
                    </p>
                </div>
            </div>
