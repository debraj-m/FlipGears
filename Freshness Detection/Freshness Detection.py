...
model = YOLO(".vscode\FlipkartGrid\est.pt")
...
df.to_csv(csv_file)# the excel sheet is saved as Freshness Detection Counts

print(f"Product detections have been saved to {csv_file}")
